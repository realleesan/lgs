...
export default function SolutionsPage() {
  return (
    <main className="min-h-screen pt-20">
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 text-sm font-semibold mb-6 font-[family-name:var(--font-body)]">
                <Zap className="w-4 h-4" />
                Giải pháp All-in-One
              </div>
              <h1 className="text-5xl lg:text-6xl font-bold mb-6 leading-tight font-[family-name:var(--font-heading)]">
                Hệ sinh thái<br />
                <span className="text-accent">Misty LGS Platform</span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link 
                  href="/contact"
                  className="bg-white text-[#1a1a1a] px-8 py-4 rounded-xl font-semibold flex items-center justify-center gap-2 hover:bg-gray-100 transition-all font-[family-name:var(--font-body)]"
                >
                ...
                <div className="grid grid-cols-2 gap-4">
                  {[
                    ...
                    <div key={i} className="bg-white/10 rounded-2xl p-6 text-center">
                      <div className="text-3xl font-bold text-white mb-1 font-[family-name:var(--font-heading)]">{stat.value}</div>
                      <div className="text-sm text-white/60 font-[family-name:var(--font-body)]">{stat.label}</div>
                    </div>
                  ))}
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              >
                ...
                <h3 className="text-xl font-bold text-[#1a1a1a] mb-2 font-[family-name:var(--font-heading)]">{item.title}</h3>
      ...
      {/* Solution Section */}
      <section className="py-24 bg-[#f0f4f8]" id="features">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-4xl font-bold text-[#1a1a1a] mb-4 font-[family-name:var(--font-heading)]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, i) => (
              ...
              >
                ...
                <h3 className="text-xl font-bold text-[#1a1a1a] mb-3 font-[family-name:var(--font-heading)]">{feature.title}</h3>
                <p className="text-gray-600 leading-relaxed font-[family-name:var(--font-body)]">{feature.desc}</p>
              </motion.div>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-4xl font-bold text-[#1a1a1a] mb-6 font-[family-name:var(--font-heading)]">
              ...
              <div className="space-y-6">
                {[
                  ...
                  <div key={i} className="flex gap-4">
                    <div className="w-6 h-6 bg-primary/10 text-primary rounded-full flex items-center justify-center shrink-0 mt-1">
                      <Check className="w-4 h-4" />
                    </div>
                    <div>
                      <h4 className="font-bold text-[#1a1a1a] font-[family-name:var(--font-heading)]">{benefit.title}</h4>
                      <p className="text-gray-600 text-sm font-[family-name:var(--font-body)]">{benefit.desc}</p>
                    </div>
                  </div>
                ))}
              </div>
              ...
              <ul className="space-y-4">
                {[
                  ...
                  <li key={i} className="flex items-center gap-3">
                    ...
                    <span className="text-white/90 font-[family-name:var(--font-body)]">{item}</span>
                  </li>
                ))}
              </ul>
            </motion.div>

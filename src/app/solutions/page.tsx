  ...
  return (
    <main className="min-h-screen pt-20">
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="absolute top-0 right-0 w-1/2 h-full bg-[#ffffff]/10 -z-10" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <h1 className="text-5xl lg:text-6xl font-bold mb-6 leading-tight font-[family-name:var(--font-heading)]">
                Hệ sinh thái<br />
                <span className="text-[#ffffff]">Misty LGS Platform</span>
              </h1>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              >
                <div className="w-12 h-12 bg-[#356df1]/10 text-[#356df1] rounded-xl flex items-center justify-center mb-4">
                  {item.icon}
                </div>
                <h3 className="text-xl font-bold text-[#356df1] mb-2 font-[family-name:var(--font-heading)]">{item.title}</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, i) => (
              ...
              >
                ...
                <h3 className="text-xl font-bold text-[#356df1] mb-3 font-[family-name:var(--font-heading)]">{feature.title}</h3>
                <p className="text-[#356df1]/70 leading-relaxed font-[family-name:var(--font-body)]">{feature.desc}</p>
              </motion.div>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-4xl font-bold text-[#356df1] mb-6 font-[family-name:var(--font-heading)]">
              ...
              <div className="space-y-6">
                {[
                  ...
                  <div key={i} className="flex gap-4">
                    <div className="w-6 h-6 bg-[#356df1]/10 text-[#356df1] rounded-full flex items-center justify-center shrink-0 mt-1">
                      <Check className="w-4 h-4" />
                    </div>
                    <div>
                      <h4 className="font-bold text-[#356df1] font-[family-name:var(--font-heading)]">{benefit.title}</h4>
                      <p className="text-[#356df1]/70 text-sm font-[family-name:var(--font-body)]">{benefit.desc}</p>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <motion.div
              ...
              whileInView={{ opacity: 1, x: 0 }}
              viewport={{ once: true }}
              className="bg-[#356df1] rounded-3xl p-8 text-[#ffffff]"
            >

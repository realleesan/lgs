        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h1 className="text-5xl lg:text-7xl font-bold text-[#356df1] leading-tight font-[family-name:var(--font-heading)]">
              ...
              <span className="text-[#ffffff] italic font-[family-name:var(--font-heading)]">Misty LGS</span>
            </h1>
            ...
            <div className="grid grid-cols-3 gap-8 pt-8 border-t border-[#356df1]/20">
              <div className="space-y-1">
                ...
                <div className="text-xs text-[#356df1]/70 uppercase font-semibold font-[family-name:var(--font-body)]">Khách hàng</div>
              </div>
              <div className="space-y-1">
                <div className="text-2xl font-bold text-[#356df1] font-[family-name:var(--font-heading)]">50+</div>
                <div className="text-xs text-[#356df1]/70 uppercase font-semibold font-[family-name:var(--font-body)]">Dự án</div>
              </div>
              <div className="space-y-1">
                <div className="text-2xl font-bold text-[#356df1] font-[family-name:var(--font-heading)]">99%</div>
                <div className="text-xs text-[#356df1]/70 uppercase font-semibold font-[family-name:var(--font-body)]">Hài lòng</div>
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="relative z-10 bg-[#ffffff] rounded-3xl shadow-2xl border-2 border-[#356df1]/20 p-4 overflow-hidden">
      ...
      <section className="py-24 bg-[#ffffff]">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <h3 className="text-4xl lg:text-5xl font-bold text-[#356df1] leading-tight mb-4 font-[family-name:var(--font-heading)]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <motion.div
                ...
                className="bg-[#ffffff] p-8 rounded-3xl border-2 border-[#356df1]/30 shadow-lg hover:shadow-xl hover:border-[#356df1]/50 transition-all group"
              >
                ...
                <h4 className="text-2xl font-bold text-[#356df1] mb-3 font-[family-name:var(--font-heading)]">{service.title}</h4>
                <p className="text-[#356df1]/70 mb-6 font-[family-name:var(--font-body)]">{service.desc}</p>
                <Link 
                  href={service.link}
      ...
      <section className="py-24 bg-[#356df1]">
        <div className="max-w-4xl mx-auto px-6 text-center text-[#ffffff]">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link 
              href="/contact"
              className="bg-[#ffffff] text-[#356df1] px-8 py-4 rounded-xl font-semibold flex items-center justify-center gap-2 hover:bg-[#ffffff]/90 transition-all font-[family-name:var(--font-body)]"
            >

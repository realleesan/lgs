    ...
    <main className="min-h-screen">
      ...
      <section className="relative min-h-screen flex items-center pt-20 overflow-hidden bg-white">
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <motion.div 
            ...
            className="space-y-8"
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 text-primary text-sm font-semibold tracking-wide uppercase font-[family-name:var(--font-body)]">
            ...
            <h1 className="text-5xl lg:text-7xl font-bold text-[#1a1a1a] leading-tight font-[family-name:var(--font-heading)]">
              ...
              <span className="text-primary italic font-[family-name:var(--font-heading)]">Misty LGS</span>
            </h1>
            ...
            <div className="grid grid-cols-3 gap-8 pt-8 border-t border-gray-100">
              <div className="space-y-1">
                ...
                <div className="text-xs text-gray-500 uppercase font-semibold font-[family-name:var(--font-body)]">Khách hàng</div>
              </div>
              <div className="space-y-1">
                <div className="text-2xl font-bold text-primary font-[family-name:var(--font-heading)]">50+</div>
                <div className="text-xs text-gray-500 uppercase font-semibold font-[family-name:var(--font-body)]">Dự án</div>
              </div>
              <div className="space-y-1">
                <div className="text-2xl font-bold text-primary font-[family-name:var(--font-heading)]">99%</div>
                <div className="text-xs text-gray-500 uppercase font-semibold font-[family-name:var(--font-body)]">Hài lòng</div>
              </div>
            </div>
          </motion.div>
      ...
      <section className="py-24 bg-[#f0f4f8]">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-primary font-bold tracking-wider uppercase text-sm mb-4 font-[family-name:var(--font-body)]">Dịch vụ của chúng tôi</h2>
            <h3 className="text-4xl lg:text-5xl font-bold text-[#1a1a1a] leading-tight mb-4 font-[family-name:var(--font-heading)]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              >
                ...
                <h4 className="text-2xl font-bold text-[#1a1a1a] mb-3 font-[family-name:var(--font-heading)]">{service.title}</h4>
                <p className="text-gray-600 mb-6 font-[family-name:var(--font-body)]">{service.desc}</p>
                <Link 
                  href={service.link}
                  className="text-primary font-semibold flex items-center gap-2 group-hover:gap-3 transition-all font-[family-name:var(--font-body)]"
                >
      ...
      <section className="py-24 bg-primary">
        <div className="max-w-4xl mx-auto px-6 text-center text-white">
          ...
          <p className="text-xl text-white/80 mb-8 leading-relaxed font-[family-name:var(--font-body)]">
            Liên hệ ngay để được tư vấn miễn phí. Chúng tôi sẽ giúp bạn tìm ra giải pháp phù hợp nhất.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link 
              href="/contact"
              className="bg-white text-primary px-8 py-4 rounded-xl font-semibold flex items-center justify-center gap-2 hover:bg-gray-100 transition-all font-[family-name:var(--font-body)]"
            >
              Liên hệ ngay <ArrowRight size={20} />
            </Link>
            <Link 
              href="/solutions"
              className="border-2 border-white/30 text-white px-8 py-4 rounded-xl font-semibold flex items-center justify-center hover:bg-white/10 transition-all font-[family-name:var(--font-body)]"
            >
              Xem giải pháp
            </Link>
          </div>

    ...
    <section id="services" className="py-24 bg-[#ffffff]">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          ...
          <p className="text-[#356df1] text-lg font-[family-name:var(--font-body)]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <motion.div
              ...
              className="bg-[#ffffff] rounded-3xl border-2 border-[#356df1]/30 shadow-xl shadow-[#356df1]/10 hover:border-[#356df1]/50 transition-all group overflow-hidden"
            >
              {/* Image */}
              ...
              <div className="p-8">
                <div className={`w-16 h-16 ${service.color} text-[#ffffff] rounded-2xl flex items-center justify-center mb-6 shadow-lg group-hover:scale-110 transition-transform`}>
                  {service.icon}
                </div>
                <h4 className="text-2xl font-bold text-[#356df1] mb-4 font-[family-name:var(--font-heading)]">{service.title}</h4>
                <p className="text-[#356df1] leading-relaxed mb-8 min-h-[80px] font-[family-name:var(--font-body)]">
                  {service.description}
                </p>
                <ul className="space-y-3">
                  {service.features.map((feature, idx) => (
                    <li key={idx} className="flex items-center gap-2 text-sm font-medium text-[#356df1] font-[family-name:var(--font-body)]">
